...
public class CoffeeMachine {
    ...
    private HashMap<String, Integer> machineResources;
    private HashMap<String, Integer> espressoResources;
    private HashMap<String, Integer> latteResources;
    private HashMap<String, Integer> cappuccinoResources;
    ...
    private boolean haveResources(HashMap<String, Integer> coffeeType) {
    ...
    private void makeCoffee(HashMap<String, Integer> coffeeType) {
    ...
    private void fillMachine() {
        ...
        int additionalWater = Integer.valueOf(getUserInput());
        System.out.print("Write how many ml of milk do you want to add: ");
        int additionalMilk = Integer.valueOf(getUserInput());
        System.out.print("Write how many grams of coffee beans do you want to add: ");
        int additionalBeans = Integer.valueOf(getUserInput());
        System.out.print("Write how many disposable cups of do you want to add: ");
        int additionalCups = Integer.valueOf(getUserInput());
